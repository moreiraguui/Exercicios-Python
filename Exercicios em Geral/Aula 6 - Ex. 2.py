# Crie um jogo de pedra, papel ou tesoura. Você deverá jogar contra o computador. Você irá sempre escolher uma das opções: 1 - pedra, 2 - papel, 3 - tesoura
# O computador irá sempre sortear um número de 1 até para jogar.
...
resultados = []
jogadas = []
v1 = 0 #Numero de vitorias do jogador 1
v2 = 0 #Numero de vitorias do jogador 2
empate = 0
...
while True:
    ...
    if (j1 == 0):
        break
    j2 = random.randint(1, 3) #Baixado da biblioteca para sortear o numero
